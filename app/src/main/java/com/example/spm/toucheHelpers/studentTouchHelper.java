...
public class studentTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    boolean isStudentOfSeance = false;
    studentOfSeanceAdapter sAdapter;


    public studentTouchHelper(studentAdapter a) {
        super(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT);
        this.adapter=a;
        this.isStudent=true;
    }

    public studentTouchHelper(studentOfSeanceAdapter a) {
        super(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT);
        this.sAdapter=a;
        this.isStudentOfSeance=true;
    }
